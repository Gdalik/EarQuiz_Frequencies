...
class Ui_AudioProcSettingsDialog(object):
    def setupUi(self, AudioProcSettingsDialog):
        ...
        AudioProcSettingsDialog.resize(400, 300)
        ...
        AudioProcSettingsDialog.setMinimumSize(QtCore.QSize(400, 300))
        AudioProcSettingsDialog.setMaximumSize(QtCore.QSize(400, 300))
        ...
        self.EQOnOffPropLab = QtWidgets.QLabel(parent=self.EQPerformanceBox)
        self.EQOnOffPropLab.setMinimumSize(QtCore.QSize(0, 20))
        self.EQOnOffPropLab.setObjectName("EQOnOffPropLab")
        self.verticalLayout.addWidget(self.EQOnOffPropLab)
        ...
        self.EQOnOffTransLay.addItem(spacerItem)
