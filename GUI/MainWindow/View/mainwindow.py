...
"}")
        ...
        self.PlaylistView.setDragDropMode(QtWidgets.QAbstractItemView.DragDropMode.InternalMove)
...
"")
        ...
        spacerItem8 = QtWidgets.QSpacerItem(5, 20, QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Minimum)
...
"}")
        ...
        spacerItem10 = QtWidgets.QSpacerItem(5, 0, QtWidgets.QSizePolicy.Policy.Fixed, QtWidgets.QSizePolicy.Policy.Minimum)
        self.HeadLayout.addItem(spacerItem10)
...
"}")
        ...
        self.HeadLayout.addItem(spacerItem11)
...
"font-weight: bold")
        ...
        spacerItem12 = QtWidgets.QSpacerItem(20, 0, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Minimum)
        self.HeadLayout.addItem(spacerItem12)
        ...
        self.NextPatternBut.setMinimumSize(QtCore.QSize(35, 0))
        self.NextPatternBut.setMaximumSize(QtCore.QSize(35, 16777215))
        font = QtGui.QFont()
        ...
        self.horizontalLayout_6.addWidget(self.NextPatternBut, 0, QtCore.Qt.AlignmentFlag.AlignLeft)
        ...
        self.TransportPanel.setMinimumSize(QtCore.QSize(900, 125))
        ...
        self.Position_Lab.setMinimumSize(QtCore.QSize(90, 30))
        self.Position_Lab.setMaximumSize(QtCore.QSize(130, 40))
        font = QtGui.QFont()
...
"}")
        ...
        self.SliceLenLay = QtWidgets.QVBoxLayout()
        self.SliceLenLay.setContentsMargins(-1, -1, 0, -1)
        self.SliceLenLay.setObjectName("SliceLenLay")
        self.SliceLenLab = QtWidgets.QLabel(parent=self.dockWidgetContents)
        self.SliceLenLab.setMaximumSize(QtCore.QSize(80, 16777215))
        ...
        self.horizontalLayout_10.addWidget(self.SliceLenSpin, 0, QtCore.Qt.AlignmentFlag.AlignLeft)
        self.secLab = QtWidgets.QLabel(parent=self.dockWidgetContents)
        self.secLab.setMaximumSize(QtCore.QSize(30, 16777215))
        self.secLab.setObjectName("secLab")
        self.horizontalLayout_10.addWidget(self.secLab, 0, QtCore.Qt.AlignmentFlag.AlignLeft)
        spacerItem15 = QtWidgets.QSpacerItem(0, 20, QtWidgets.QSizePolicy.Policy.MinimumExpanding, QtWidgets.QSizePolicy.Policy.Minimum)
        ...
        self.Duration_Lab.setMinimumSize(QtCore.QSize(90, 30))
        self.Duration_Lab.setMaximumSize(QtCore.QSize(130, 40))
        font = QtGui.QFont()
        font.setPointSize(16)
        font.setBold(False)
        font.setWeight(50)
...
"font-weight: normal")
        ...
        self.SupportProject.setMaximumSize(QtCore.QSize(260, 60))
