...
"}")
        ...
        self.EQtabWidget.setAutoFillBackground(True)
        self.EQtabWidget.setStyleSheet(u"background:rgb(240, 240, 240)")
...
"}")
        ...
        sizePolicy1.setHeightForWidth(self.SupportProject.sizePolicy().hasHeightForWidth())
        self.SupportProject.setSizePolicy(sizePolicy1)
        self.SupportProject.setMaximumSize(QSize(260, 60))
        self.SupportProject.setAllowedAreas(Qt.BottomDockWidgetArea|Qt.RightDockWidgetArea)
        self.dockWidgetContents_4 = QWidget()
        self.dockWidgetContents_4.setObjectName(u"dockWidgetContents_4")
        self.SupportProject.setWidget(self.dockWidgetContents_4)
        MainWindow.addDockWidget(Qt.RightDockWidgetArea, self.SupportProject)
