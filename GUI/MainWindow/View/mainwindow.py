...
"}")
        ...
        self.TransportPanel.setMinimumSize(QtCore.QSize(1128, 115))
...
"}")
        ...
        self.StartTimeEdit.setMinimumSize(QtCore.QSize(115, 20))
        ...
        self.StartTimeEdit.setAlignment(QtCore.Qt.AlignmentFlag.AlignLeading|QtCore.Qt.AlignmentFlag.AlignLeft|QtCore.Qt.AlignmentFlag.AlignVCenter)
...
"}")
        ...
        self.EndTimeEdit.setMinimumSize(QtCore.QSize(115, 20))
        self.EndTimeEdit.setMaximumSize(QtCore.QSize(105, 30))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.EndTimeEdit.setFont(font)
        self.EndTimeEdit.setWrapping(False)
        self.EndTimeEdit.setAlignment(QtCore.Qt.AlignmentFlag.AlignLeading|QtCore.Qt.AlignmentFlag.AlignLeft|QtCore.Qt.AlignmentFlag.AlignVCenter)
...
"}")
        ...
        self.SliceLenSpin.setMinimumSize(QtCore.QSize(50, 20))
...
"font-weight: normal")
        ...
        self.Eq_Settings.setMinimumSize(QtCore.QSize(246, 150))
        ...
        self.GainRangeSpin.setMinimumSize(QtCore.QSize(55, 0))
        ...
        self.BWBox.setMinimumSize(QtCore.QSize(140, 0))
        ...
        self.BWLayout.addItem(spacerItem17)
...
"}")
        ...
        self.AddPlusRemoveAudioLay.addItem(spacerItem19)
...
"}")
        ...
        self.actionAudio_Processing_Settings = QtGui.QAction(parent=MainWindow)
        self.actionAudio_Processing_Settings.setObjectName("actionAudio_Processing_Settings")
        self.actionEQ_Always_On_In_Test_Mode = QtGui.QAction(parent=MainWindow)
        self.actionEQ_Always_On_In_Test_Mode.setCheckable(True)
        self.actionEQ_Always_On_In_Test_Mode.setObjectName("actionEQ_Always_On_In_Test_Mode")
...
"- EQ Pattern changes do not affect EQ Settings."))
        ...
        self.actionAudio_Processing_Settings.setText(_translate("MainWindow", "Audio Processing Settings..."))
        self.actionEQ_Always_On_In_Test_Mode.setText(_translate("MainWindow", "EQ Always On In Test Mode"))
