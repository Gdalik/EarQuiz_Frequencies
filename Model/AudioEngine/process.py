...
def eq_proc(cur_sample, samplerate: int, freq: int or float, freq2=None, boost_cut='+', boost_cut2='+', gain_depth=12, Q=1.41, proc_t_perc=40):
    ...
    eq1 = PeakFilter(cutoff_frequency_hz=freq, gain_db=gain, q=Q)
    if freq2:
